...
class Rol(models.Model):
    ...
    Nombre=models.CharField(max_length=30,choices=(('Administrador', ("Administrador")),('Ciente', ("Ciente"))), default='Ciente')
    def __str__(self):
        return self.Nombre
...
class Habitacion(models.Model):
    ...
    Tipo=models.CharField(max_length=30,choices=(('Individual', ("Individual")),('Doble', ("Doble")),('Triple', ("Triple")),('Suite', ("Suite"))), default='Individual')
    ...
    Estado=models.CharField(max_length=30,choices=(('Disponible', ("Disponible")),('Reservada', ("Reservada")),('Ocupada', ("Ocupada"))), default='Disponible')
    def __str__(self):
        return self.numHabitacion

class Reserva(models.Model):
    
    Persona=models.ForeignKey(Persona(), on_delete=models.CASCADE, default="")
    numReserva=models.CharField(max_length=10,blank=False,default='')
    numHabitacion=models.ForeignKey(Habitacion(), on_delete=models.CASCADE, default="")
